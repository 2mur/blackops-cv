### > PROJECT: NYUSU (NEWS SITE)

**DATA:** GLOBAL INTEL INTERCEPT
**DESC:** Automated ingestion, vectorization, and synthesis of unstructured text data into interactive intelligence graphs.
